...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 Sveikų receptų 2.0",
    description:
  ...
  brand: {
    name: "Esencia Pro",
    tagline: "1000 Sveikų receptų 2.0",
  },
  ...
  hero: {
    ...
    cta: "Žiūrėti vaizdo įrašą dabar! 🔊",
    ...
    items: [
      {
        ...
        tag: "1 PRIEDAS",
        title: "E. knyga: 15 sveikų sriubų",
        desc: "15 šildančių sriubų receptų, kuriuose mažai angliavandenių ir cukraus.",
        value: "15 €",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "2 PRIEDAS",
        title: "E. knyga: 10 sveikų glotnučių",
        desc: "10 gaivių glotnučių receptų su mažu angliavandenių ir cukraus kiekiu.",
        value: "15 €",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "3 PRIEDAS",
        title: "E. knyga: 15 sveikų užkandžių",
        desc: "15 greitų ir sveikų užkandžių idėjų sergantiems diabetu.",
        value: "15 €",
      },
      {
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "1 Priedas — 15 sveikų sriubų",
      "2 Priedas — 10 sveikų glotnučių",
      "3 Priedas — 15 sveikų užkandžių",
  ...
  faq: {
    authorRole: "Esencia Pro · Sveikos mitybos komanda",
    authorHeadline: "Skanus maistas, kuris rūpinasi tavo sveikata",
    authorBio:
      "Mes, „Esencia Pro“, tikime, kad diabetas neturi atimti valgymo malonumo. Kiekvienas receptas sukurtas taip, kad galėtum mėgautis maistu be kaltės jausmo ir išlaikyti visišką gliukozės kontrolę.",
    authorImageAlt: "Esencia Pro komanda",
  ...
  footer: {
    brand: "PRO ESCALA",
    copyright: "Autorių teisės © proescala.online ® 2025",
    disclaimer:
